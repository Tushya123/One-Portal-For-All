...
const EmployeeRoles = () => {
  ...
  const [originalEmployeeRole, setOriginalEmployeeRole] = useState([]);
  ...
  const fetchEmployeeRole = async (searchTerm = "") => {
    try {
      setLoading(true);
      ...
      const response = await axios.post(
        `${process.env.REACT_APP_BASE_URL}/employeerole/employeeroleforpagination`,
        {
          skip: skip,
          per_page: perPage,
          ...
          <div className="row">
            <div >
              <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                <div className="col-6">
                  <h4 className="mb-0 abc1111">Employee Role</h4>
                </div>
                <div className="col-6">
                  <div className="d-flex align-items-center justify-content-end" >
                    ...
                    <Link to="/add-employeerole" >
                      <button className="custom_hover btn btn-primary btn-color" type="submit" style={{ display: 'flex' }}>
                        ...
                        <span className="abc1111">Add Employee Role</span>
                      </button>
                    </Link>
                  </div>
                </div>
                    ...
                    <div className="table-responsive">
                      {/* <Table className="align-middle table-nowrap mb-0">
                        <thead className="table-light">
                          <tr>
                            <th scope="col">ID</th>
                            <th scope="col">Type of Functions</th>
                        ...
                        {employeeRole.length > itemsPerPage && (
                          <>
                            ...
                            <li
                              className={`page-item ${
                                currentPage ===
                                Math.ceil(employeeRole.length / itemsPerPage)
                                  ? "disabled"
                                  : ""
                              }`}
                            >
