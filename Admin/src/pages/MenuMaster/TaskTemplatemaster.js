...
const TaskTemplateMaster = () => {
    const navigate = useNavigate();
    const { getRolesResponsibilities, deleteTaskTemplate } = useContext(SignContext);
    ...
    const handledeleteTaskTemplate = async () => {
        if (selectedForUpdate) {
            ...
            try {
                await deleteTaskTemplate(selectedForUpdate);
    ...
    const fetchRole = async (searchTerm = "") => {
        try {
            ...
            const response = await axios.post(
                `${process.env.REACT_APP_BASE_URL}/tasktemplate/listTemplates`,
                {
                    skip: skip,
                    per_page: perPage,
    ...
    return (
        <>
            ...
            <DeleteModal
                ...
                onDeleteClick={() => handledeleteTaskTemplate()}
                    ...
                    <div className="row">
                        <div >
                            <div className="page-title-box d-sm-flex align-items-center justify-content-between">
                                <div className="col-6">
                                    <h4 className="mb-0 abc1111">Tool Template</h4>
                                </div>
                                <div className="col-6">
                                    <div className="d-flex align-items-center justify-content-end" >
                                        ...
                                        <Link to="/Tasktemplate" >
                                            <button className="custom_hover btn btn-primary btn-color" type="submit" style={{ display: 'flex' }}>
                                                ...
                                                <span className="abc1111">Add Tool Template</span>
                                            </button>
                                        </Link>
                                    </div>
                                </div>
                        ...
                        <Col xl={12}>
                            <Card>
                                <div class="card-header align-items-center d-flex card-body">
                                    <h4 class="card-title mb-0 flex-grow-1">Tool Template Details</h4>  </div>
...
export default TaskTemplateMaster;
